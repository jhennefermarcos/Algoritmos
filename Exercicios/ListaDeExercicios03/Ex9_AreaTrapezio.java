...
public class Ex9_AreaTrapezio {
    ...
    /*
     * Algoritmo trapézio – Elabore um algoritmo em fluxograma para calcular a área
     * de um
     * trapézio. Sabe-se que:
     * areatrapezio =(baseMaior + baseMenor) ∗ altura/2
     * Lembre-se a altura, a base maior e a base menor devem ser números maiores que
     * zero. Se o
